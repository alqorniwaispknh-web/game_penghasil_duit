document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btn) {
    btn.addEventListener("click", () => {
      ...
      if (clickCount === 1) {
        window.open("https://s.shopee.co.id/9pcFtNyNIG", "_blank");  /* ===GANTI # DENGAN LINK DI ANTARA "dan"==== */
      } else {
...
===================== */
function goCek() {
  window.open("https://s.shopee.co.id/5AqQKr1FQo", "_blank");   /* ===GANTI # DENGAN LINK DI ANTARA "dan"==== */
}
